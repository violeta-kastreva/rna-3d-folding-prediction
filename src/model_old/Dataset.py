...
class RNADataset(Dataset):
    ...
    def __init__(self, indices, data_dict, k: int = 5, train: bool = True, flip: bool = False):

        self.indices=indices
        self.data_dict: dict[str] = data_dict
        self.k: int = k
        self.tokens: dict[str, int] = {nt: i for i, nt in enumerate(self._TOKENS)}
